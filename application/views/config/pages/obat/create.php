<body id="page-top">
    ...
    <div class="card-body">
        <form method="post" action="<?= base_url('config/obat/post') ?>">
            <!-- === input obat === -->
            ...
            <div class="form-group">
                ...
                <input type="text" id="harga_pembelian"   name="harga_pembelian" min="0" class="form-control" required>
            </div>

            <!-- === input penjualan obat === -->
            <div class="form-group">
                <label>Harga Penjualan</label>
                <input type="text" id="harga_jual"  name="harga_penjualan" min="0" class="form-control" required>
            </div>

            <!-- === input tanggal kedaluarsa obat === -->
            <div class="form-group">
                <label>Tanggal Kadaluarsa</label>
                <input type="date" name="tanggak_kadaluarsa" class="form-control" required>
            </div>
